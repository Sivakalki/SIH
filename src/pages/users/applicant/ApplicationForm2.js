...
//         formData.append("sub_caste", values.subCaste);
//         formData.append("gender", values.gender);
//         formData.append("parent_guardian_type", values.parentGuardianType);
//         formData.append("parent_guardian_name", values.parentGuardianName);
//         formData.append("marital_status", values.maritalStatus);
//         formData.append("religion", values.religion);
//         formData.append("parent_religion", values.parentReligion);
...
//                             </Select>
//                         </Form.Item>
//                         <Form.Item name="sub_caste" label="SubCaste" rules={[{ required: true, type: 'string', message: 'Please input a valid string!' }]}>
//                             <Input />
//                         </Form.Item>
//                         <Form.Item
//                             label="Gender"
