...
export default function MroDashboard() {
  ...
  const [news] = useState([
    'Welcome to CertiTrack MRO Dashboard',
  ...
  const fetchDashboardData = async () => {
    if (token) {
      try {
        const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/mro/load_dashboard`, {
          headers: {
      ...
      <Layout style={{ minHeight: '100vh', marginTop: '80px' }}>
        ...
        <Layout style={{ marginLeft: '250px' }}>
          ...
          <Content style={{ margin: '88px 16px 24px', minHeight: 280 }}>
            <Title level={2} style={{ marginBottom: '8px' }}>MRO Dashboard</Title>
              ...
              <Col span={10}>
                <Space direction="vertical" style={{ width: '100%' }} size={16}>
                  ...
                  <Card
                    ...
                    onClick={() => navigate('/mro/applications')}
                    hoverable
                  >
                  ...
                  <Card
                    ...
                    bodyStyle={{ padding: '24px' }}
                    onClick={() => navigate('/mro/completed')}
                    hoverable
                  >
                    <Space direction="vertical" size={8}>
                      <Space size={12}>
